...
export default function NotFound() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: "var(--inv-bg)", color: "var(--inv-base)", fontFamily: "var(--font-base)", padding: 24, textAlign: "center" }}>
      <div style={{ fontSize: 72, fontWeight: 700, color: "var(--inv-accent)", fontFamily: "DM Serif Display, serif", lineHeight: 1 }}>404</div>
      <div style={{ fontSize: 18, marginTop: 8, fontFamily: "DM Serif Display, serif", color: "var(--inv-accent)" }}>Halaman Tidak Ditemukan</div>
      <div style={{ fontSize: 13, marginTop: 8, lineHeight: 1.6, maxWidth: 300 }}>
        Link undangan mungkin sudah kadaluarsa atau tidak valid.
      </div>
